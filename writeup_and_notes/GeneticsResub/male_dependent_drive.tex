...
At first sight, female meiosis appears primed for exploitation by such selfish systems, \yb{and here we ask if spam do indeed evolve to collaborate with female drivers to exploit this apparent weakness in the defense against meiotic drive.} \newline 
%Why then is the requirement of fertilization to complete female meiosis so ubiquitous? 

\yb{The threat to meiotic fairness posed by the fertilization requirement for completion of female meiosis seems both real and avoidable. 
We say this threat is avoidable because the stage at which female meiosis requires fertilization 
	varies widely across taxa, and in a few animals female meiosis is complete upon ovulation \
	(that is, fertilization is not required for female meiosis \citep[e.g. Table 1 in ][]{Masui_book}). 
We say this threat is real because there is substantial evidence that female meiotic drive is an 
	evolutionary force and considerable opportunity for sperm to influence female drive.  
While research to date has identified a few of what are likely the most extreme female meiotic 
	drivers \citep{Agulnik1990, Fishman2008, Hiatt2003,Novitski1951, Pardo-ManuelDeVillena2001c}, 
	rapid evolution of centromeres, telomeres and other basic components of the meiotic machinery, 
	suggest consistent evolution of meiotic drivers and suppressors of meiotic drive
	 \citep[e.g. ][]{Anderson2008, Anderson2009, Axelsson2010, Malik2009a}, and the inexpense of 
	 genotyping-by-sequencing platforms for non-model systems will likely 
	identify subtle meiotic drivers in numerous non-model systems.  
...
{\bf{GRAHAM DO MORE????} } 
Genetic evidence from the \emph{In} and \emph{Om}  drive systems in mice suggests that the 
 ...
 While ruling out the alternative hypothesis of early selection on zygotes in these cases is challenging  \citep[see pages
	52-54 in][]{Burt2006}, it appears that the extent to which \emph{In} and \emph{Om} distort the second female meiotic division partially depends on the 	
...
\yb{While we do not claim that female meiotic arrest evolved specifically to recruit helpful sperm to defend against meiotic drive, the delayed completion of female meiotic drive will not in fact encourage sperm to assist renegade drivers.}  
