...
Compared to exact results (Figure S\ref{Bistab_homozyg_cost_fig}), Equations
...
simple parameter search (Figure S\ref{bistable_additive})
...
If the cost of drive is fully recessive (i.e. $s_h=0$), assuming HWE, 
	...
	$s\lessapprox d_{hom}-1/2$, approximations well supported by exact results (Figure S\ref{Effect_of_dominance}).
