...
because alleles compete \yb{for inclusion in} the  product of female meiosis transmitted to the egg. 
...
The fact that female meiosis \yb{is} often left uncompleted until after
      fertilization in many animals appears to run counter to this interpretation, 
      as this delay provides an opportunity for sperm\yb{-acting} alleles to
...
The population genetic theory presented herein suggests that
	\gc{in fact} sperm nearly always evolve to increase the fairness of female
        meiosis in the face of genomic conflicts. 
These results are consistent with \yb{the apparent sperm- dependence}  \gc{of the best characterized female meiotic drivers in animals to date.} 
...
An allele that biases female meiosis in its favor (i.e. a meiotic driver), may increase in frequency even if it entails a pleiotropic fitness cost \citep{Prout1973}, generating a genetic conflict between the success of the driver and the organism.
...
At first sight, female meiosis appears primed for \gc{conflict caused by
the such selfish systems.} Here we ask if sperm do indeed evolve to collaborate with female drivers to exploit this apparent weakness in the defense against meiotic drive. \newline 





\yb{Before doing so, it is worth considering whether there is any evidence that sperm could (or do), influence female meiosis. }
\gc{It is becoming
 ...
 Some of these have known functions, for example, in most
        ...
        component of the mitotic machinery for the zygote. 
Detailed functional studies and paternal effect mutations in model
systems further highlight
 that sperm-transmitted products have a wide-range of functions in
 the completion of syngamy, zygotic development, and the resumption of
 female meiosis \cite{Miller:01, McNally:05,REF}. 
 For example, in \emph{C. elegans}, premature deployment of the aster 
 	-- a vital component of mitotic machinery provided by the sperm, 
...
hence alleles could potentially have functional effects on
...
\gc{THERE may be too much bio. detail in previous paragraph, I can
  add more refs. once we've decided on content
centriole : http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3144413/?report=classic}
\newline

%It is certainly not the case that sperm is mechanistically incapable of influencing female meiosis.
...
%	disrupts MII meiotic segregation in the egg, leading to a triploid zygote \citep{McNally2012}.
\yb{Current evidence suggests that sperm influence on female meiotic drive is not only possible, but likely. }
Evidence from both the \emph{In} and \emph{Om}  -- suggests that the 
	 transmission of alternate alleles in heterozygous females can depend on sperm haplotype.  
%There are current only two polymorphic, well-characterized female meiotic drive systems in
...
\yb{The fact that the two best characterized, polymorphic systems of putative female 
	meiotic drive systems identified to date in animals (\emph{In} and \emph{Om}) 
	show this effect suggests that if female meiotic drive is
	common the role of sperm in modifying female drive will be important as well. } \newline

\yb{Numerous lines of evidence suggest that female meiotic drive is an 
	evolutionary force, and therefore the opportunity for sperm to influence female drive likely had applications to many animals}.   
...
\yb{Because female meiotic drive is likely common and consequential, 
	...
	that is, what is the expected influence of sperm on female drive? } 
...
Thus, there is little selective benefit to females in preventing sperm to influence female meioses. 
 \yb{In fact, a mutant female which completes meiosis before 
 	fertilization is giving up the protection from meiotic drivers potentially offered by sperm, 
	and is therefore more likely to produce low fitness offspring. }
...
Assuming that a traditional driver segregates at its equilibrium frequency ({\bf{Model 1}}), we investigate the evolution of tightly linked ({\bf{Models 4 and 5}}), and unlinked ({\bf{Model 6}}) sperm-dependent modifiers of drive (We also briefly compare Model 6, to Model 6' - the suppression of female drive by an unlinked female acting suppressor).  
...
that genotype frequencies follow Hardy Weinberg Equilibrium (HWE), we note which analytical results are approximations. 
...
\yb{We note that the evolution of sperm-acting drive  suppressors unlinked to a driver (Model 6) is both qualitatively and quantitatively similar to the evolution  of a female-acting drive suppressor (compare Equations \ref{unlinked} and \ref{femunlinked}).}
...
\gc{Thus females can} delay the completion of meiosis until after fertilization 
...
So long as the transmission advantage of female meiotic drive outweigh
...
\yb{The theory presented herein provides a strong prediction -- 
organisms in which female 
meiosis is not completed until after fertilization sperm will act to suppress female drive at the stage at which they can influence meiosis. 
%Therefore, for example, when fertilized by drying sperm, we expect meiosis to be fairer when  females are fertilized by 
Contrary to expectations of a \gc{naive verbal} ``green-beard'' model, 
we are unsurprised by the observation that female meiosis is fairer when fertilized by sperm bearing the drive allele in two of the best described cases of female meiotic drive in animals (the \emph{Om} and \emph{In} loci in mice \citep{Agulnik1993,Wu2005}).  
Given the immense benefit to sperm of hampering female drive, 
...
We note that while these predictions follow straightforwardly from the
theory presented above, tests of meiotic drive, 
and especially sperm dependent meiotic drive require a high standard
of evidence 
to exclude plausible alternative hypotheses such as genotypic inviability including epistatic maternal X zygotic lethality.}  \newline

\gc{Our theory also encourages phylogenetic hypotheses concerning the relationship between the opportunity 
...
For example, we predict that a lower opportunity for female meiotic drive,
        e.g. an animal lineage with a history of high inbreeding
        or selfing, 
        may be accompanied by a relaxation of the requirement of fertilization for the
        completion of female meiosis (although 
   \yb{     opportunities to test this hypothesis may be limited because }
        %this effect may be weaks as such
        lineages may only persist for a short time). 
Our results also suggests that 
%Another   hypothesis that our work suggests is we might expect 
        that phylogenetic variation in the stage of female meiosis when
        fertilization occurs to influence the prevalence of
        female meiotic drive.
For example, in taxa where meiosis I is completed
by the egg pre-fertilization, including humans, centromere drive may
be more common as sperm based modifiers can not intercede than in
species where fertilization occurs during MI. 
Such hypotheses could be tested if the speed of centromere
turnover serves as a proxy for the efficacy of MI drive. }
\newline
...
\yb{Our model does not directly speak to the evolutionary origin of
  female meiotic arrest \citep[for a review and evaluation of such
  hypotheses see][]{Mira1998}.
However, given the existence of female meiotic arrest, 
	and that its timing relative to
	fertilization as well as the interactions between sperm and egg are variable across species  \citep{Karrbook:09} 
	the nature of the meiotic arrest and interactions between sperm and egg may be molded by selection to reduce the opportunity for female meiotic drive, 
	while selfish drivers may evolve in concert, to overcome these adaptations. 
%leave female meiosis open to sabotage by sperm collaborators, but
%rather that  an 
%evolutionary loss of female meiotic arrest will result in the loss of sperm defense against female meiotic drivers. } 
  }
%However, given that arrest does occur its timing relative to
%fertilization, various features of the interaction between sperm and
%egg and divergence of these features across species  \citep{Karrbook:09} could be subject
%to selection to conflict between female meiotic drivers and alleles
%elsewhere in the genomes of sperm and eggs.
%the mechanism by which it occur
%mechanistic features, and evolutionary changes among taxa
%various features of the
%mechanism of fertilization 
%however, our work does imply that the fertilization requirement does
%not 
%leave female meiosis open to sabotage by sperm collaborators, but
%rather that  an 
%evolutionary loss of female meiotic arrest will result in the loss of sperm defense against female meiotic drivers. } 
...
\subsubsection*{Model $6^\prime$. Unlinked female acting drive-modifier:}
\yb{The dynamics of a female-acting drive modifier are comparable to those describing a female acting drive suppressor.  
When rare and fully dominant and in linkage and in HWE, the change in frequency of a rare unlinked, female-acting drive modifier is 
