...
Before doing so, it is worth considering whether there is any evidence that sperm could (or do), influence female meiosis. 
It is becoming
...
systems further highlight
 ...
 the \gc{egg activation, completion of syngamy, zygotic development, and the resumption
 and successful completion of
 female meiosis} \cite[e.g.][]{Yasuda:95,Loppin:05,Miller:01, McNally:05,Churchill:03}. 
 For example, in \emph{C. elegans}, \gc{premature deployment of the sperm aster 
...
%	disrupts MII meiotic segregation in the egg, leading to a triploid zygote \citep{McNally2012}.
Current evidence suggests that sperm influence on female meiotic drive is not only possible, but likely. 
...
\gc{Given the wide-spread requirement of fertilization for the completion
of  female meiosis it seems possible that various feature of the
interaction between sperm and egg have evolved as another mechanism to enforce an equitable transfer of genetic material.}
\gc{HOW ABOUT THE ABOVE.}

%%don't thi k this helped: 
...
%Another   hypothesis that our work suggests is we might expect 
        ...
        fertilization occurs may influence the prevalence of
        female meiotic drive.
