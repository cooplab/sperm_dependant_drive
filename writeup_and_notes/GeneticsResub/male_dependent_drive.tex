...
of  female meiosis it seems possible that various features of the
interaction between sperm and egg have evolved as a mechanism to enforce an equitable transfer of genetic material.}
...
%Another   hypothesis that our work suggests is we might expect 
        ...
        female meiotic drive.
\gc{For example, in taxa where meiosis I is completed
by the egg pre-fertilization centromere drive may
be more common as sperm-based modifiers can not intercede, as compared to
...
However, given the existence of female meiotic arrest, 
	\gc{and that its timing and mechanistic details are variable across species \citep{Masui_book,Karrbook:09} 
	...
	and selfish drivers evolving in concert to overcome these adaptations. }
