...
For example, we predict that a lower opportunity for female meiotic drive,
        ...
        completion of female meiosis (although this effect may be
        weaks as such
        lineages may only persist for a short time). Another
        hypothesis that our work suggests is we might
        expect that phylogenetic variation in the stage of female meiosis when
        fertilization occurs to play a role in the prevalance of
        female meiotic drive.
...
fertilisation, various features of the interaction between sperm and
