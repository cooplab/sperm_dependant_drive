...
because alleles compete for inclusion in the  product of female meiosis that will be transmitted to the egg. 
...
That females  of many animal species do not complete meiosis until after
     fertilization appears to run counter to this interpretation
...
These results are consistent with the apparent sperm-dependence of the best characterized female meiotic drivers in animals to date.  
...
Thus, there is little selective benefit to females in preventing sperm to influence female meioses, 
	\yb{and in fact, females eschewing this delay would potentially lose sperm assistance in the suppression of meiotic drivers.}  
Given the wide-spread requirement of fertilization for the completion
	...
	and egg likely evolved as a mechanism 
	to enforce an equitable transfer of genetic material.
...
The theory presented herein provides a strong prediction -- 
	for organisms in which female  meiosis is not completed until after fertilization, 
...
Contrary to expectations of a naive verbal ``green-beard'' model, 
	our results are consistent with the observation that female meiosis 
	is more fair when fertilized by sperm bearing the drive allele in 
	two of the best described cases of female meiotic drive in 
	animals (the \emph{Om} and \emph{In} loci in mice \citep{Agulnik1993,Wu2005}).  
...
However, crosses between populations or species are likely to provide critical tests of our theory -- 
	...
	fertilized by heterospecific sperm because such sperm have not evolved to counter novel females meiotic drivers. 
We further predict that segregation in F1 females backcrossed to parental species will likely be biased with a deficit 
	of transmission of the paternal species allele from the F1  female.   
...
%Another   hypothesis that our work suggests is we might expect 
        ...
        female meiotic drive.
For example, in taxa where females complete meiosis
	before fertilization, centromeric drive may
	be more common than in species which sperm interact with eggs arrested  in MI, 
	because in the prior case sperm-based modifiers can only intercede during the $2^\text{nd}$, but not $1^\text{st}$ meiotic division. }
As a potential test of this hypothesis the speed of centromere
	turnover could be compared in species in which sperm iterate with eggs paused at MI and MII 
	(assuming the pace of centromere turnover serves as a proxy for the efficacy of MI drive). 
\newline
