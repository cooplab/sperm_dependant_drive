...
\begin{singlespace}
\item \emph{{\bf{Point 2 -- }} The format of this submission departs from the style of GENETICS (model description and analysis, literature citations, etc.). As a result, it is unclear whether GENETICS is the appropriate or even the intended forum for this work.} \newline \\
...
We apologize for the formatting issues. We have corrected these
...
To aid in your consideration, we provide the previous reviews and a
...
\begin{singlespace}
	...
	We hope that new theoretical work (including ours) coupled
        with the increasing ease of genetics in many non-model systems, 
        will encourage the discovery of additional drive systems in non-model organisms in the coming years.
\end{singlespace}
...
\begin{singlespace}
	...
	however, the initial spread of the sperm suppressor is equal to (when the female suppressor is dominant), or more rapid (otherwise) than the female suppressor. 
...
{\bf{Response -- }} We have added a Methods section, which introduces these six models (+ model 6$^\prime$), and makes our manuscript more in line with the GENETICS format.
\end{singlespace}
