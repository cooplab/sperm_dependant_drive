...
{\bf{Response -- }} This revision makes it clear that our primary argument is that, given a chance to influence female meiosis, sperm will evolve to increase its fairness (as reflected in our title), {\bf{AND NOT}} that females should delay the completion of meiosis so as to recruit help from sperm in making meiosis fair (as could have been interpreted from our previous draft). 
\end{singlespace}
...
(2) research questions that can be addressed by molecular genetics, transmission genetics, studies of genome structure, phylogenetics and population genetics. As such, GENETICS is a particularly appropriate venue for our paper. 
Our view is echoed by comments from Reviewer 2 who stated  `Overall I found the paper to be well written and organized, and because of this, the theory that the authors describe will be accessible to a broad spectrum of the readership of Genetics ? not just other theoreticians.'
...
We have therefor corrected issues with our formatting, and included a METHODS section to introduce our models, as is the tradition in GENETICS. \\
\end{singlespace} 
\end{itemize}
We thank you for your previous comments and for consideration of this revised manuscript. 
To aid in your consideration, we provide  previous reviews and a description of how we have addressed individual comments, below. 
\\
\\
Sincerely,  \\
...
\begin{singlespace}
	...
	We hope that new theoretical work (including ours) coupled with the falling expense of GBS, will encourage the discovery of additional drive systems in non-model organisms in the coming years.
\end{singlespace}
