...
machinery) provided by the sperm can disrupts MII meiotic segregation
in the egg, leading to a triploid zygote \citep{McNally2012}. 
Thus, there is direct mechanistic evidence for that sperm can influence female meiosis.
 Additionally, genetic evidence from the In and Om  drive system sin mice suggests that the 
