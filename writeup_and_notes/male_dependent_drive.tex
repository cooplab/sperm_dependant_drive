...
For example, we predict that a lower the opportunity for female meiotic drive,
        (e.g. an animal lineage with a long history of high inbreeding or selfing) 
...
Figure \ref{IEggsperm}B by plotting $f_B=f_{BB}+ \frac{1}{2}f_{AB}$
...
In the parameter space below the invasion (solid) line the self-promoter
 ...
 dash) line the self-promoter can fix in the population. In the last
