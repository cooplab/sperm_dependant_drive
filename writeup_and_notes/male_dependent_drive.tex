...
offspring, o\"{o}genesis is inherantly susceptible to such conflicts,
as alleles can compete to be transmitted into the egg
(meiotic drive). 
Genomics conflicts drive the rapid evolution of surpression mechanisms, and
...
\yb{We concluded with an analysis of a related mode (Model 3) - in which drivers influence their transmission in females via paternal genotype, rather than sperm haplotype.}
