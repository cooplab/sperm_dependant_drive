...
%complicates the dynamics of the system, as the dominance of
 % the genotype of the male effect on female drive must be considered as a parameter. 
%Some circumstances the dominance of the drive effect in
%males can allow the  maintenance of the allele a polymorphism, the parameter range that
