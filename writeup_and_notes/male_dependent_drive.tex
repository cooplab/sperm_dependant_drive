...
When rare, a fully recessive, self-promoting driver can only invade when $s$ 
	...
	is approximately less than $(2 d - 1)/(4 d)$ -- see dashed black line in Figure \ref{Eggsperm}B). 
...
\begin{figure}
\includegraphics[width = 1 \textwidth]{Figures/selfprom.eps}
...
\begin{figure}
	\includegraphics[width = 0.7
          \textwidth]{Figures/twolocus.eps}
\caption{Models of a sperm-acting drive modifier tightly linked to a meiotic driver. 
{\bf (A) } Loci exist in tightly linked haplotypes (top of A). 
	Genotype of sperm at the modifier locus (ancestral and sperm acting modifier empty and filled squares, respectively) alters transmission  
	at the drive locus (circles) during female meiosis. 
	{\bf{A1)}} In the standard model of drive, 
	the driver (filled black circle) and non-driver (empty circle) are transmitted with probabilities $d_0$ 
	and $1-d_0$, respectively. 
	{\bf{A2)}} The $B^+$ haplotype increases the transmission of the drive allele ($d_1 > d_0$), and due to their shared genetic background, also increases its drive. 
	{\bf{A3 \& A4)}} The sperm-acting modifier acts to decrease drive  ($d_1=1/2$ in A3 \& A4. More generally, $d_1 < d_0$). 
...
If this sperm-acting drive suppressor arises on 
	the non-driving $A$ background (creating a third allele $A^{-}$, Figure \ref{Eggsperm_3_allele_cartoon}A4, Model 5), 
